...
#include "../../Black_and_White_Chess/board.h"
...
QT_MOC_LITERAL(1, 6, 8), // "setCount"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 1), // "x"
QT_MOC_LITERAL(4, 18, 1) // "y"

    },
    "Board\0setCount\0\0x\0y"
};
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setCount((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::setCount)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Board::setCount(int _t1, int _t2)
{
